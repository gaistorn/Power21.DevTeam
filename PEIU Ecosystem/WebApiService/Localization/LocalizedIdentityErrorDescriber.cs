...
namespace PES.Service.WebApiService.Localization
{
    public class LocalizedIdentityErrorDescriber : IdentityErrorDescriber
    {
        public static IdentityResult UserNotFound(LocalizedIdentityErrorDescriber describer)
        {
            IdentityResult _result = IdentityResult.Failed(describer.UserNotFound());
            return _result;
        }
        ...
        {
            return this.GetErrorByCode("UserNotFound");
        }
        ...
        /// <summary>
        /// Returns an <see cref="IdentityError" /> indicating user lockout is enabled.
        /// </summary>
        /// <returns>An <see cref="IdentityError" /> indicating user lockout is enabled..</returns>
        public IdentityError UserLockoutEnabled()
        {
            return this.GetErrorByCode("UserLockoutEnabled");
        }
        ...
        public IdentityError PasswordDoesNotMatched()
        {
        ...
        {
            string local = this.localizer.GetString(code, parameters);
